...
class Decom_Trainer(BaseTrainer):
    def train(self):
        ...
        # scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[100, 120, 160,220,300], gamma=0.1)
        #0.98477
        # scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[100,130,200], gamma=0.1)
        try:
            for iter in range(self.epochs):
                ...
                if iter % self.save_frequency == 0:
                    torch.save(self.model.state_dict(), './checkpoints_nt/decom_net_without_rec.pth')
    ...
    @no_grad
    def test(self, epoch=-1, plot_dir='./images/samples-decom-last-700a'):
        self.model.eval()
        hook = 0
...
if __name__ == "__main__":
    ...
    if args.checkpoint is not None:
        pretrain = torch.load('./checkpoints/decom_net.pth')
    ...
    # root_path_train = r'waterdataseta/our485'
    # root_path_test = r'waterdataseta/eval15'
